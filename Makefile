PREFIX="sdx-"
REPOS="rabbit-monitor" "ops" "collect" "decrypt" "validate" "receipt-rrm" "store" "transform-cs" "transform-cora" "downstream" "downstream-cora" "sequence" "console" "mock-receipt"
